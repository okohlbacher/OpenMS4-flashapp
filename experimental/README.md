...
`pyopenms-macos-arm64.lock.json` record the ci.3 release wheel SHA-256, exact Core
...
gh release download pyopenms-v4.0.0.dev0-ci.3 --repo okohlbacher/OpenMS4-pyopenms \
